...
\lhead{\small\assignmentClass{ : }{}\ \assignmentTitle} % Left header; output the instructor in brackets if one was set
\chead{} % Centre header
...
\newcommand{\assignmentSection}[1]{
	{
		...
		\rule{0.9\textwidth}{0.5pt} % Horizontal rule
...
\title{
	\textsc{\LARGE Haute École d'Ingénierie et de Gestion du Canton de Vaud}\\[1.5cm] % logo Ecole
